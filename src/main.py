...
def main() -> None:
    ...
    get_events_period_arg = input("""Укажите за какой период собрать данные.
    Возможные значения:
    ...
    get_expenses_date_arg = input("""Вы можете указать дату за которую будет сформирован отчёт. Маска: YYYY-MM-DD
