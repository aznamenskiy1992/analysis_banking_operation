...
def test_get_main_data_for_main(mock_get_events, mock_filter_transaction_by_search_str, mock_get_expenses_for_3_months_by_category, result_all_functions_for_main, capsys):
    ...
    [{"Категория": "Супермаркеты", "Сумма операции с округлением": 321.78}]\n"""
