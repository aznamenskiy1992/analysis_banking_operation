...
def test_none_category_for_get_expenses_for_3_months_by_category(get_data_for_reports):
...
def test_category_is_not_str_for_get_expenses_for_3_months_by_category(get_data_for_reports):
